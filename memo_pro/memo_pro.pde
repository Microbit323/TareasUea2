...
void draw(){
  ...
  img = loadImage("../assets/Imagenes/kiosco.jpg"); // ruta de la imagen
  image(img, 400, 150); // cargo la imagen en una posición xy
  
   // Dibuja el círculo
  fill(30, 97, 140); // Color azul
  ...
  fill(255, 153, 200); // Color blanco para el texto
  ...
  textSize(25); // Tamaño de la fuente
   text("lugares interesantes de Lerma", width - 10, height - 300); // Primera línea de texto
  text("Gabriel Garcia Marquez", width - 10, height - 100); // Segunda línea de texto
